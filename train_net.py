...
def train(cfg, local_rank, distributed):
    ...
    if cfg.SOLVER.RESUME:
        ...
        if cfg.DATASETS.NAME == "activitynet":
            ...
            weight_path = './outputs/%s_charades_32x32_k5l8_combined/%s_model_%de.pth' % (cfg.MODEL.MMN.FEAT2D.NAME, cfg.MODEL.MMN.FEAT2D.NAME, cfg.SOLVER.RESUME_EPOCH - 1)
        else:
