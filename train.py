...
@click.command(cls=CommandAwareConfig('config'))
@click.option('--config', default=None, type=str)
@click.option('--seed', default=25285)
# dataset
@click.option('--train_ann_file', default="./data/Charades_STA/combined_charades_train_remove_repeat_action_videos.json")
@click.option('--test_ann_file', default="./data/Charades_STA/charades_multi_target.json")
...
# logging
@click.option('--logdir', default="./logs/mmn-multi-constrastive-v1")
def main(**kwargs):
    del kwargs['config']
